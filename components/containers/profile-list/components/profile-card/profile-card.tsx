...
export const ProfileCard = ({ profile: profileData }: ProfileCardCardProps) => {
  ...
  return (
    <div className="ml-4">
      <div className="relative mt-20 rounded-xl border bg-card text-card-foreground shadow-sm">
        <div className="relative -mt-16 flex w-full flex-col items-start gap-3 lg:absolute lg:-top-16 lg:left-[-24px] lg:mt-0 lg:flex-row">
          <div className="-ml-6 w-fit shrink-0 rounded-xl border bg-white shadow-md transition-transform hover:scale-105 lg:ml-0">
