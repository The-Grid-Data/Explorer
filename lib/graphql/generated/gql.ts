 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query SearchProfilesByRanking(\n    $order_by: [TheGridRankingOrderBy!]\n    $where: TheGridRankingBoolExp\n    $limit: Int\n    $offset: Int\n  ) {\n    theGridRankings(\n      limit: $limit\n      offset: $offset\n      where: $where\n      order_by: $order_by\n    ) {\n      connectionScore\n      rootId\n      roots {\n        profileInfos {\n          ...ProfileCardFragment\n        }\n      }\n    }\n  }\n"): typeof import('./graphql').SearchProfilesByRankingDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment AssetMediaFragment on Assets {\n    media {\n      id\n      url\n      mediaType {\n        id\n        name\n      }\n    }\n  }\n"): typeof import('./graphql').AssetMediaFragmentFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment MediaFragment on ProfileInfos {\n    media {\n      id\n      url\n      mediaType {\n        id\n        name\n      }\n    }\n  }\n"): typeof import('./graphql').MediaFragmentFragmentDoc;
